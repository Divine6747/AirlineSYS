...
namespace AirlineSYS
{
    public partial class frmScheduleFlight : Form
    {
        ...
        {
            if (!ValidateFlightUtility.ValidateFlightField(cboDeptAirportFlight, cboArrAirportFlight, cboOperatorCodeFlight, txtNumFlightSeats.Text, dtpDeptFlight.Value, cboDeptTime, lblFlightNumberDetail.Text))
            {
                return;
            }
            else
